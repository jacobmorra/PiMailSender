...
import argparse #for user-friendly command line
import datetime #date and time
import imutils #image processing functions (OpenCV)
import time #allow for sleep 
import cv2 #OpenCV module for handling images
